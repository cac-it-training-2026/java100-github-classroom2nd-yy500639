...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//配列の宣言および初期化処理を記述する
		String[] voice = { "へい！らっしゃい！！", "何にしますか！今日は活きのいいコハダが入ってますよ", "まいどあり！！またどうぞ" };
		...
		for (int i = 0; i < 3; i++) {
			System.out.println("あいさつパターン" + (i + 1) + "...「" + voice[i] + "」");
		}
		...
		int pattern = Integer.parseInt(str) - 1;

		System.out.print("あいさつを吹き込んでください＞");
		voice[pattern] = br.readLine();
